...
export const INITIAL_CATEGORIES: MockCategory[] = [
  ...
  },
  {
    ...
    name: 'Advanced Peels',
    slug: 'advanced-peels',
    description: 'Clinical epidermal resurfacing and medical-grade multi-acid skin regeneration.',
    default_duration_minutes: 60,
    buffer_minutes: 20,
    is_active: true,
  },
  {
    ...
    description: 'Deep cellular restoration, microdermabrasion, and semi-permanent radiance treatments.',
