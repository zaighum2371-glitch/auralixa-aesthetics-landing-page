      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-sm text-foreground">
            Contact our team at <a href="tel:+1234567890" className="text-accent font-medium hover:underline">(123) 456-7890</a> or <a href="mailto:info@auralixa.com" className="text-accent font-medium hover:underline">info@auralixa.com</a>
          </p>
        </div>
      </div>
    </section>
