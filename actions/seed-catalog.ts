  ...
  const categoriesToSeed = [
    {
      ...
      description: 'Advanced non-invasive facial sculpting, peptides, and collagen induction therapies.',
    ...
    },
    {
      ...
      description: 'High-potency antioxidant, glutathione, and melanin-regulating complex infusions.',
    ...
    },
    {
      ...
      description: 'Cellular revitalization, diamond microdermabrasion, and semi-permanent glow facials.',
      default_duration_minutes: 60,
      buffer_minutes: 15,
      is_active: true,
    },
    {
      name: 'Injectable Enhancements',
      slug: 'injectable-enhancements',
      description: 'Doctor-administered bio-remodelling, Profhilo cellular hydration, and skin boosters.',
      default_duration_minutes: 45,
      buffer_minutes: 15,
      is_active: true,
    },
    {
      ...
      description: 'Targeted localized cryotherapy sculpting, lymphatic drainage, and tightening.',
